package wayeet.ghidra.format.lx.model;
...
import wayeet.file.format.lx.LinearHeader;
import wayeet.ghidra.format.lx.datatype.LxByteOrder;
import wayeet.ghidra.format.lx.datatype.LxCpuType;
import wayeet.ghidra.format.lx.datatype.LxOSType;
import wayeet.ghidra.lx.InvalidHeaderException;

public class Header extends wayeet.file.format.lx.LinearHeader implements StructConverter {
